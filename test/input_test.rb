...
', output
  ...
  def test_input_with_class_and_id
    markdown = '__.form-input#name-field Input|Enter your full name__'
    output = @parser.parse(markdown)
    assert_equal \
'<div class="ui input form-input" id="name-field">
  <input type="text" placeholder="Enter your full name" />
</div>
', output
  end

  def test_input_with_multiple_classes
    markdown = '__.input-primary.input-large#email-input Input|Enter email address__'
    output = @parser.parse(markdown)
    assert_equal \
'<div class="ui input input-primary input-large" id="email-input">
