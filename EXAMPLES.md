...
1. [Interactive Examples](#interactive-examples) - **NEW!**
...
9. [Component Showcase](#component-showcase)

---

## Interactive Examples 🎮

**NEW!** Try out MarkdownUI components interactively with our comprehensive examples page!

### ✨ What's Available

Visit the [Interactive Examples Page](repl/examples.html) to see:

#### 🎯 Elements Tab
- **Button**: All button types, sizes, colors, and states
- **Divider**: Horizontal, vertical, and styled dividers
- **Flag**: Country flags for international applications
- **Header**: H1-H6 headers with various styles and sub-headers
- **Icon**: Complete Semantic UI icon set with variations
- **Image**: Avatar, standard, and circular images
- **Input**: Text inputs, search fields, and labeled inputs
- **Label**: Status labels, colored labels, and corner labels
- **List**: Bulleted, numbered, and linked lists
- **Loader**: Different loader sizes and text loaders
- **Reveal**: Image reveals with various animations
- **Segment**: Content containers with different styles
- **Step**: Step indicators for multi-step processes

#### 📚 Collections Tab
- **Breadcrumb**: Navigation breadcrumbs with icons
- **Form**: Complete forms with validation and error states
- **Grid**: Responsive grid layouts and nested grids
- **Menu**: Horizontal, vertical, and contextual menus
- **Message**: Success, info, warning, and error messages
- **Table**: Striped, celled, and definition tables

#### 👁️ Views Tab
- **Card**: Content cards with images and metadata
- **Feed**: Activity feeds with user actions
- **Item**: List items with avatars and descriptions
- **Statistic**: Numerical statistics with labels

#### ⚙️ Modules Tab
- **Accordion**: Collapsible content sections
- **Checkbox**: Radio buttons and checkboxes
- **Dimmer**: Content dimming with overlays
- **Dropdown**: Selection and search dropdowns
- **Modal**: Modal dialogs and popups
- **Progress**: Progress bars with percentages
- **Rating**: Star and heart rating systems
- **Search**: Local and remote search components
- **Shape**: 3D shape transitions
- **Sidebar**: Slide-in sidebars
- **Tab**: Tabbed content navigation
- **Transition**: CSS animations and transitions

### 🚀 How to Use

1. **Open the REPL**: Start with `repl/index.html`
2. **Click Examples**: Use the "Examples" button in the header
3. **Browse Categories**: Navigate through Elements, Collections, Views, and Modules
4. **Copy Syntax**: Each example shows the MarkdownUI syntax that generates the HTML
5. **Try in REPL**: Copy the syntax to the REPL and see it render instantly

### 🎨 Features

- **Live Syntax Display**: Every component shows its MarkdownUI syntax
- **Semantic UI Integration**: Full Semantic UI styling and behavior
- **Responsive Design**: Works on all screen sizes
- **Interactive Elements**: Working buttons, forms, and modals
- **Complete Coverage**: All MarkdownUI components documented

### 🔗 Quick Access

- **REPL**: [repl/index.html](repl/index.html)
- **Interactive Examples**: [repl/examples.html](repl/examples.html)
